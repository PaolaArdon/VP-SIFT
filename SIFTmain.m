...
% [timeSequence2] = plottingSequence( path, sequence, setSize );
% 
...
% %% Implement a testing system for SEQUENCE1 with different windows size
%  path = ['SEQUENCE1/Sequence1Homographies.mat'];
%  sequence =1; setSize =16; type ='SIFT';
%  [roc1, roc2] = plottingSequence_vlfeat( path, sequence, setSize);
 
 %% Implement a testing system for SEQUENCE2 with different windows size
 path = ['SEQUENCE2/Sequence2Homographies.mat'];
 sequence =2; setSize =9; type ='SIFT';
 [roc1, roc2] = plottingSequence_vlfeat( path, sequence, setSize);

% %% Implement a testing system for SEQUENCE3 with different windows size
%  path = ['SEQUENCE3/Sequence3Homographies.mat'];
%  sequence =3; setSize =18; type ='SIFT';
%  [roc1, roc2] = plottingSequence_vlfeat( path, sequence, setSize);
